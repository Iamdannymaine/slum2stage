...
const Chidinma_Story = () => {
  return (
    <section className="w-full bg-secondary grid grid-cols-1 lg:grid-cols-3 gap-x-8">
      <div className="h-auto flex lg:flex-col">
      ...
      <div className="flex flex-col col-span-2 p-8 pt-32 items-start justify-start">

  ...
  return (
    <button
      ...
      className={clsx(
        ...
        variant === "pill-ghost" &&
        `rounded-[40px] bg-secondary pill_filled_btn_shadow hover:text-white text-primary font-semibold hover:bg-primary_hover text-sm py-2 p-1 px-8 font-sans [--shadow-color:#1b3142]`,
        className
      )}
      disabled={disabled}
    >
